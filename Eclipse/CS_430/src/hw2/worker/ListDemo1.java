 ...
 * background using a helper thread.  
 * 
 * SOLUTION TO HW2: See changes in LookupWorker class (bottom of file)
 */
public class ListDemo1 extends JFrame
{
  ...
  private class LookupWorker extends Thread
  {
    ...
    public void run()
    {
      // lookup performed by this LookupWorker thread
      StaffData newRecord = LookupService.lookup(arg);

      // GUI updates performed by event thread
      SwingUtilities.invokeLater(() -> {
        ...
        {
          System.out.println("Worker canceled. ");
        }
